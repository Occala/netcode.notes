...
I've also done a fair amount of physical conveyor related stuff in VRChat already, so that part is trivial to do in a basic way (move objects along a track), it's the networked portion that's important
