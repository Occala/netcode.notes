...
It follows a similar origin reading scheme for senders/receivers, but doesn't push bytes. Proximity acts directly as the normalized value for both sliders. The mute toggle is simply a bool receiver instead
