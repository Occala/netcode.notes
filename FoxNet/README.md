...
To network spawn an entity, you just hold a shared idea of what prefabs can be spawned. Give it a unique identifier and inform everyone. Now everyone has an object they can refer to as the same instance
